...
public class Tab implements Parcelable {
     ...
     *
     * @param mode The mode, which should be set, as a value of enum {@link PorterDuff.Mode} or null, if
     ...
     *
     * @param show True, if the progress bar should be shown, false otherwise
     */
